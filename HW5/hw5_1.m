...
rt_5_1 = data(q_idx,5);save('../HW5/rt_5_1.mat', 'rt_5_1');
st_5_1 = data(q_idx,5);save('../HW5/st_5_1.mat', 'st_5_1');

figure; plot(t,az_st(q_idx,:)); title('az (acceleration)');grid on;xlabel('time (sec)');
az_5_1 = az_st(q_idx,:); save('5_1_az.mat', 'az_5_1');
figure; plot(t,q_st(q_idx,:)); title('Pitch Rate (deg/sec)');grid on;xlabel('time (sec)');
q_5_1 = q_st(q_idx,:); save('5_1_q.mat', 'q_5_1');
figure; plot(t,del_st(q_idx,:)); title('Elevon (deg)');grid on;xlabel('time (sec)');
del_5_1 = del_st(q_idx,:); save('5_1_del.mat', 'del_5_1');
figure; plot(t,deldot_st(q_idx,:)); title('Elevon rate (deg/sec)');grid on;xlabel('time (sec)');
deldot_5_1 = deldot_st(q_idx,:); save('5_1_deldot.mat', 'deldot_5_1');
