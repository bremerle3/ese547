...
% figure; plot(t,az_st(20,:),'x'); title('az (acceleration)');grid on;
% figure; plot(t,q_st(20,:),'x'); title('Pitch Rate (deg/sec)');grid on;
% figure; plot(t,del_st(20,:),'x'); title('Elevon (deg)');grid on;
% figure; plot(t,deldot_st(20,:),'x'); title('Elevon rate (deg/sec)');grid on;
